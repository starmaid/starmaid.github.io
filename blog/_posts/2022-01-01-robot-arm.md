...
comments: false
image:
  path: /blog/img/robotarm_assets/2021-6.gif
---

Written January 2022

![The completed arm.](/blog/img/robotarm_assets/header.png)
...
![Triangle with sides and angles labeled.](/blog/img/robotarm_assets/triangle.png)
...
![Gif of the arm controlled with servos.](/blog/img/robotarm_assets/2017.gif)
...
![The arm moving peacefully.](/blog/img/robotarm_assets/2017-2.gif)
...
![A servo lifts and drops the sharpie on the arm.](/blog/img/robotarm_assets/2017-3.gif)
...
![The sharpie is placed precisely on locations marked by a ruler.](/blog/img/robotarm_assets/2017-4.gif)
...
On August 3rd, 2020, I was discouraged enough after crashing my drone into a lake that I decided to finally give another crack at the drawing arm I had been putting off. I don't think I was in the mood to do some programming, so I just opened solidworks, grabbed some scrap aluminum channel I had used for my original [lightbars project](http://starmaid.github.io/blog/hallie-lights) and finally built a robust mechanical version. The metal rods for the elbow are construction marking flags, burning through that pack of 100 I bought.

![The almost completed arm.](/blog/img/robotarm_assets/2020.jpg)

![Closeup on the servo mount.](/blog/img/robotarm_assets/2021-4.png)
...
![The partially disassembled arm in a plastic bin on a kitchen table. There are several ice cubes in the bin.](/blog/img/robotarm_assets/ice.jpg)
...
![A PCB with wires and motor drivers soldered to it.](/blog/img/robotarm_assets/2021.png)

![Underside of the PCB, showing the solder connections.](/blog/img/robotarm_assets/2021-2.png)
...
![Gif of the completed arm moving slowly.](/blog/img/robotarm_assets/2021-3.gif)
...
![Gif of the arm drawing 'straight' lines. They are bowed and inaccurate.](/blog/img/robotarm_assets/2021-5.gif)
...
![Gif of the arm drawing an oval.](/blog/img/robotarm_assets/2021-6.gif)
...
![Screenshot of several discord messages that are controlling the arm.](/blog/img/robotarm_assets/grad.png)
