...
One of them runs the watering, lights, and webcam for my plants. [There is a project post about it here.](https://starmaid.github.io/blog/plants)
...
One runs my matrix chat server, just as I set it up in [this tutorial.](http://starmaid.github.io/blog/matrix-setup) I will be honest, it works better on an RPI4, but it would really work best on an actual server. This was more of a pet project and is currently offline at the time of writing.
